...
function renderWorkUnits(decision: PlanningDecisionV1): string {
...
function renderVerification(decision: PlanningDecisionV1): string {
...
export function renderPlan(decision: PlanningDecisionV1): string {
  return [
    "# Plan",
    "",
    "## Request",
